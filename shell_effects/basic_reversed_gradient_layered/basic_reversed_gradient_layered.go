package basic_reversed_gradient_layered
...
func CreateBasicReversedLayeredEffect(text string, from shell_styles.Output, to shell_styles.Output) shell_core.GradientEffect {
